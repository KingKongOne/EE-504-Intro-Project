...
# Title: Fm Rx
# Generated: Sun Apr  8 11:02:34 2018
##################################################
...
class fm_rx(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.rtlsdr_source_0.set_center_freq(91.3, 0)
        ...
        self.rational_resampler_xxx_0 = filter.rational_resampler_ccc(
                interpolation=audio_interp*audio_rate,
                decimation=int(samp_rate),
                taps=None,
                fractional_bw=None,
        )
        self.low_pass_filter_0 = filter.fir_filter_ccf(1, firdes.low_pass(
        	1, 250000, 100000, 1000, firdes.WIN_HAMMING, 6.76))
